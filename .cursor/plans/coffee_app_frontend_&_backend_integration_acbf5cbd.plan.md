...
- `NEXT_PUBLIC_GOOGLE_MAPS_API_KEY` - **Required**: For Google Maps JavaScript API (map rendering only, not Places API)
- `FASTAPI_BASE_URL` - Default: `http://localhost:8000` (for development)
